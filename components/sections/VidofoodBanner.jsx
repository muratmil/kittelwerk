      ...
      <div className="container mx-auto px-6 py-6">
        ...
        >
          <div className="flex items-center gap-4">
            <div className="w-8 h-8 bg-[#5B21F5] border-2 border-ink flex-shrink-0" />
            <div>
              <span className="text-[9px] font-black uppercase tracking-[0.25em] opacity-40">Partner</span>
              <p className="font-black text-sm uppercase tracking-tight leading-none">
                Digitales Bestellsystem für Gastronomen —{' '}
                <span style={{ color: '#5B21F5' }}>vidofood.de</span>
              </p>
