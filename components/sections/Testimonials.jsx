const REVIEWS = [
  ...
  { initials: 'AA', name: 'Adem Altun', place: 'Dönermeister · Hameln', color: 'bg-olive', quote: '"Unkomplizierte Abwicklung, schnelle Lieferung. Das Logo sitzt sauber auf dem Stoff — genau so wie wir es uns vorgestellt haben."' },
