...
export const ORDER_STATUS = {
  neu:            { label: 'Neu',            cls: 'bg-sun text-ink' },
  in_produktion:  { label: 'In Produktion',  cls: 'bg-blue-100 text-blue-800' },
  pausiert:       { label: 'Pausiert',       cls: 'bg-orange-100 text-orange-700' },
  versandt:       { label: 'Versandt',       cls: 'bg-olive/20 text-olive' },
  abgeschlossen:  { label: 'Abgeschlossen',  cls: 'bg-ink/10 text-ink/50' },
  storniert:      { label: 'Storniert',      cls: 'bg-tomato/10 text-tomato' },
  // Teklif çemberi — Wipello'dan gelen kayıtlar burada başlıyor.
  angebot_offen:       { label: 'Angebot offen',   cls: 'bg-sun text-ink' },
  angebot_kontaktiert: { label: 'Kontaktiert',     cls: 'bg-blue-100 text-blue-800' },
  angebot_angenommen: { label: 'Angebot angenommen', cls: 'bg-olive/20 text-olive' },
  angebot_abgelehnt:  { label: 'Angebot abgelehnt',  cls: 'bg-tomato/10 text-tomato' },
};
