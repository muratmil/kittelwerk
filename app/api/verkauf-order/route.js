    ...
    html: `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:32px;">
        ...
        <table style="width:100%;border-collapse:collapse;">
          ...
          <tr><td style="padding:6px;color:#555;">E-Mail</td><td>${email ? `<a href="mailto:${email}">${email}</a>` : '<span style="color:#999">Keine Angabe</span>'}</td></tr>
          ...
          ${discountAmount > 0 ? `<tr><td style="padding:6px;color:#3D6B4F;">Rabatt</td><td style="color:#3D6B4F;">−${discountAmount.toFixed(2)}€ (${discountLabel})</td></tr>` : ''}
        </table>
