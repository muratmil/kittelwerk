...
export const FREE_PRINT_TYPES = ['none', 'front', 'back', 'both', 'siebdruck'];
...
const PRINT_PRICES = { none: 0, front: 5.0, back: 5.0, both: 5.0, siebdruck: 0, bestickung_front: 2.0, bestickung_back: 3.0 };
